...
for epoch in range(1, 3): #up to 51
    model.train()
    epoch_loss = 0
...
torch.save(model.state_dict(), "residual_unet_selfsupervised_gaussian.pth")

import os

model.load_state_dict(torch.load("residual_unet_selfsupervised_gaussian.pth"))
model.eval()

input_root = "baseline"
output_root = "gaussian"
