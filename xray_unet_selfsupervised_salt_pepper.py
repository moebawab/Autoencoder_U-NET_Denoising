...
torch.save(model.state_dict(), "residual_unet_selfsupervised_saltpepper.pth")

import os

model.load_state_dict(torch.load("residual_unet_selfsupervised_saltpepper.pth"))
model.eval()

input_root = "baseline"
output_root = "salt_and_pepper"
